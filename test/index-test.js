...
const ruleNoTodo = require("textlint-rule-no-todo").default || require("textlint-rule-no-todo");
const filterRule = require("../index");
const markdownPlugin = require("@textlint/textlint-plugin-markdown").default || require("@textlint/textlint-plugin-markdown");
...
`;
            ...
            assert.strictEqual(result.messages[0].message, "Found TODO: 'TODO: 本文のTODOはエラーになる'");
        });
    });
